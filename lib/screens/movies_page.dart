...
import 'package:EntertainmentMania/widgets/movies_widgets/wide_movies.dart';
import 'package:EntertainmentMania/widgets/movies_widgets/potrait_movies.dart';
import 'package:EntertainmentMania/widgets/movies_widgets/trending_people.dart';
    ...
    return Scaffold(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [
          Color.fromARGB(255, 95, 5, 232),
          Color.fromARGB(255, 207, 217, 238)
  ...
  Widget buildIndicator() {
    return AnimatedSmoothIndicator(
        effect: ExpandingDotsEffect(
            activeDotColor: Color.fromARGB(255, 61, 34, 239),
            dotHeight: 5,
            dotWidth: 12),
