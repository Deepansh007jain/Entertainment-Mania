...
import 'package:EntertainmentMania/widgets/shows_widgets/potrait_tv.dart';
import 'package:EntertainmentMania/widgets/shows_widgets/wide_tv.dart';
    ...
    return Scaffold(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: [
          Color.fromARGB(255, 62, 8, 241),
          Color.fromARGB(255, 241, 247, 241)
  ...
  Widget buildIndicator() {
    return AnimatedSmoothIndicator(
        effect: ExpandingDotsEffect(
            activeDotColor: Color.fromARGB(255, 241, 49, 11),
            dotHeight: 5,
            dotWidth: 12),
